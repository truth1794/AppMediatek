...
namespace AppMediatek.dal
{
    ...
    public class PersonnelAcces
    {
        ...
        public List<Personnel> GetLePersonnel()
        {
            ...
            {
                string req = "select p.idpersonnel as idpersonnel, s.nom as service, p.nom as nom, p.prenom as prenom, p.tel as tel, p.mail as mail ";
                ...
                try
                {
                    ...
                    if (records != null)
                    {
                        ...
                        foreach (Object[] record in records)
                        {
                            ...
                            Personnel perso = new Personnel((int)record[0], (string)record[1], (string)record[2],
